...
<body class="text-white bg-black">
    ...
    <div x-data="{ loading: true }" 
        ...
        <div class="relative w-20 h-20">
            ...
            <div class="absolute border-4 border-gray-800 rounded-full inset-2 border-t-red-600 animate-spin-slow"></div>
        </div>
    </div>
    ...
    <div class="container relative px-4 pt-24 mx-auto">
        ...
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-5xl font-bold md:text-7xl">
                Welcome to <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-800 to-red-500">Snow n Stuff</span>
            </h1>
            ...
            <div class="flex flex-col items-center justify-center gap-4 mt-12 sm:flex-row">
                <a href="#releases" class="w-full px-4 py-2 text-center text-white transition-all duration-300 border-2 border-red-800 hover:bg-red-800 hover:scale-105 sm:w-auto">
                    Our Music
                </a>
                <a href="#artists" class="w-full px-4 py-2 text-center text-white transition-all duration-300 border-2 border-red-800 hover:bg-red-800 hover:scale-105 sm:w-auto">
                    Our Artists
                </a>
                <a href="/blog" class="w-full px-4 py-2 text-center text-white transition-all duration-300 border-2 border-red-800 hover:bg-red-800 hover:scale-105 sm:w-auto">
                    Blog/Latest News
                </a>
            </div>
        </div>
