<!-- About Section -->
<section id="about" class="relative py-24" data-reveal>
    ...
    <div class="container relative px-4 mx-auto">
        <x-section-header eyebrow="About" title="Snow 'n' Stuff" />
        ...
        <div class="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
                <!-- Decorative Corners -->
                <div class="absolute z-10 w-16 h-16 transition-all duration-300 border-t-2 border-l-2 border-red-800 left-5 top-5 group-hover:left-2 group-hover:top-2"></div>
                <div class="absolute z-10 w-16 h-16 transition-all duration-300 border-b-2 border-r-2 border-red-800 right-5 bottom-5 group-hover:right-2 group-hover:bottom-2"></div>

                <!-- Branded composition (replaces legacy cyborg image) -->
                <x-about-mark />
            </div>
            ...
            <div class="space-y-6 text-gray-300">
                ...
                <p class="italic">
                    <x-brand-name /> is releasing Tech House, Deep House, House and Techno.
                    Management for: THK, G&S, <x-brand-name /> and Style Da Kid among others.
                    Tastemaker &amp; Curator of several Spotify playlists. Deep House &amp; Ibiza and many more playlists.
                </p>

                <ul class="space-y-4">
                    <li class="flex items-start space-x-3">
                        <x-icons.check class="flex-shrink-0 w-6 h-6 mt-1 text-red-800" />
                        <span class="flex-1">
