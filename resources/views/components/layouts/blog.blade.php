...
<body class="flex flex-col min-h-screen text-white bg-black">
    <!-- Top Bar -->
    <div x-data="{ isVisible: true }" @scroll.window="isVisible = window.pageYOffset < 100" x-show="isVisible"
    ...
    <header x-data="{ isScrolled: false, mobileMenuOpen: false }" @scroll.window="isScrolled = window.pageYOffset > 100"
        ...
        <div class="container px-4 mx-auto">
            <nav class="flex items-center justify-between py-4">
                <!-- Logo -->
                <a href="/"
                    class="text-2xl font-bold text-white transition-colors duration-300 hover:text-red-800">
                    Snow n Stuff
                </a>
                ...
                <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="px-4 py-6 space-y-4">
                        ...
                        <a href="/blog"
                            class="block text-red-800 transition-colors duration-300 hover:text-red-700">Blog</a>
                        <a href="/#gallery"
